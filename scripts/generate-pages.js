...
<section style="padding:0 0 96px">
  <div class="container">
    ...
    <a class="btn btn-ghost" href="${rel(depth, 'process')}" style="margin-top:var(--space-6)">See the full process &rarr;</a>
  </div>
</section>
${renderCtaSimple(depth)}`;
